...
Car::Car(float fuel_):Car(fuel,0){

}
Car::Car(float fuel_, float speed_):Car(fuel,speed,0){

}

//Delegating constructor of C++11
Car::Car(float fuel_, float speed_, int pass):Car(fuel,speed,passengers){
	++totalcount;
	fuel = fuel_;
	speed = speed_;
	passengers = pass;
