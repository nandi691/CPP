...
int main()
{
	...
	int sum {};
	//auto FindSum = [sum](auto &x) mutable{ //It will show 0 as sum is copied by value
	...
	//Assume offset is a variable or object
	// [offset] - Capture offset by value
	// [&offset] - Capture offset by reference
	// [&] - Capture all variables by reference
	// [=] - capture all variables by value
	// [&,offset] - Capture all variables by reference except offset
	// [=,&offset] - capture all variables by value except offset
	// [this] - Capture this (i.e all member variables)
}
